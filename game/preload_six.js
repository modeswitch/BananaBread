...
Module['FS_createPath']('/packages', 'base', true, true);
    ...
    filePreload181.open('GET', 'packages/base/zo_min.ogz', true);
    ...
    filePreload182.open('GET', 'packages/base/zo_min.cfg', true);
    ...
    filePreload183.open('GET', 'packages/base/zo_min.wpt', true);
    ...
    dataFile.open('GET', 'six.data', true);
    ...
    dataFile.onload = function() {
      ...
      var curr;
        ...
        curr.response = byteArray.subarray(26757690,28002869);
        curr.onload();
      
        curr = DataRequest.prototype.requests['packages/base/zo_min.cfg'];
        curr.response = byteArray.subarray(28002869,28004561);
        curr.onload();
      
        curr = DataRequest.prototype.requests['packages/base/zo_min.wpt'];
        curr.response = byteArray.subarray(28004561,28012497);
        curr.onload();
