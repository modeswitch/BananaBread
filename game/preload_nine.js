...
Module['FS_createPath']('/packages', 'base', true, true);
    ...
    filePreload183.open('GET', 'packages/base/starfox.wpt', true);
    ...
    dataFile.onload = function() {
      ...
      var curr;
        ...
        curr.response = byteArray.subarray(26757690,34880839);
        curr.onload();
      
        curr = DataRequest.prototype.requests['packages/base/starfox.cfg'];
        curr.response = byteArray.subarray(34880839,34882529);
        curr.onload();
      
        curr = DataRequest.prototype.requests['packages/base/starfox.wpt'];
        curr.response = byteArray.subarray(34882529,34944387);
        curr.onload();
