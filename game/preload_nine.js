...
Module['FS_createPath']('/packages', 'base', true, true);
    ...
    filePreload186.open('GET', 'packages/base/starfox.ogz', true);
    ...
    filePreload187.open('GET', 'packages/base/starfox.cfg', true);
    ...
    filePreload188.open('GET', 'packages/base/starfox.wpt', true);
    ...
    dataFile.onload = function() {
      ...
      var curr;
        ...
        curr.response = byteArray.subarray(43923157,52046306);
        curr.onload();
      
        curr = DataRequest.prototype.requests['packages/base/starfox.cfg'];
        curr.response = byteArray.subarray(52046306,52047996);
        curr.onload();
      
        curr = DataRequest.prototype.requests['packages/base/starfox.wpt'];
        curr.response = byteArray.subarray(52047996,52109854);
        curr.onload();
